...
from ..lazy import DiagLazyTensor # TODO added by DANNY
...
class ExactGP(GP):
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Posterior mode
            ...
            # TODO my change: in predictionsOnly-mode, if testSize exceeds a threshold (e.g. 1000), slice up xTest and call forward again on each slice. Then merge results
            ...
            if predictionsOnly and testSize > batchThresholdSize:
                ...
                fakeCovar = DiagLazyTensor(torch.ones(predictive_mean.numel()))
            ...
            with settings._use_eval_tolerance():
                predictive_mean, predictive_covar = self.prediction_strategy.exact_prediction(full_mean, full_covar, **kwargs)
